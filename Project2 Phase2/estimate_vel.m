function [vel, omg, t, MSE,n] = estimate_vel(sensor, worldnew)
...
persistent tracker oldsensor oldpoints corners prevvel 
global zH
...
%     out = insertMarker(frame,corners, '+');
%     drawnow
%     imshow(out);
    ...
    vel = vel*0.5 + prevvel*0.5;
    
%     if ( (vel - prevvel) > 1.5*prevvel)
%         
%        vel = prevvel ;  
%     end
%     vel =  velocities(1:3);
